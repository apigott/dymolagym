...
/* DSblock model generated by Dymola from Modelica model Modelica.Mechanics.Rotational.Examples.CoupledClutches
 Dymola Version 2021x (64-bit), 2020-10-09 translated this at Wed Jun  9 11:23:00 2021
...
#define NHash1_ -1650214866
#define NHash2_ 1392744277
#define NHash3_ 0
#define NI_    0
#define NRelF_ 21
#define NRel_  21
...
DYNX(W_,78) = (PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch3.mu_pos[1, 1]}, {clutch3.mu_pos[1, 2]}, 0, 1)")
  Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,25), 1, 1), 
  RealTemporaryDense( &DYNX(DP_,26), 1, 1), 0, 1).yi0_0_0member);
PopAllMarks();
DYNX(W_,52) = (PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch2.mu_pos[1, 1]}, {clutch2.mu_pos[1, 2]}, 0, 1)")
  Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,18), 1, 1), 
  RealTemporaryDense( &DYNX(DP_,19), 1, 1), 0, 1).yi0_0_0member);
PopAllMarks();
DYNX(W_,23) = (PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch1.mu_pos[1, 1]}, {clutch1.mu_pos[1, 2]}, 0, 1)")
...
MixedSystemOfEquations(13, DYNX(DYNhelp,0))
  ...
  /* Introducing 10 common subexpressions used in 12 expressions */
  ...
  DYNX(DYNhelp,13) = IF DYNX(W_,12) THEN 0.0 ELSE IF DYNX(W_,8) THEN 0 ELSE 
    ...
    "Modelica.Math.Vectors.interpolate({clutch1.mu_pos[1, 1]}, {clutch1.mu_pos[1, 2]}, clutch1.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,4), 1, 1), 
    RealTemporaryDense( &DYNX(DP_,5), 1, 1), DYNX(X_,3), 1).yi0_0_0member) ELSE 
    IF DYNX(W_,11) THEN  -(PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch1.mu_pos[1, 1]}, {clutch1.mu_pos[1, 2]}, clutch1.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,4), 1, 1), 
    RealTemporaryDense( &DYNX(DP_,5), 1, 1), DYNX(X_,3), 1).yi0_0_0member) ELSE 
    IF PRE(DYNX(W_,18), 1) == 1 THEN (PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch1.mu_pos[1, 1]}, {clutch1.mu_pos[1, 2]}, clutch1.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,4), 1, 1), 
    RealTemporaryDense( &DYNX(DP_,5), 1, 1), DYNX(X_,3), 1).yi0_0_0member) ELSE 
     -(PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch1.mu_pos[1, 1]}, {clutch1.mu_pos[1, 2]},  -clutch1.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,4), 1, 1), 
  ...
  DYNX(DYNhelp,16) = IF DYNX(W_,67) THEN 0.0 ELSE IF DYNX(W_,63) THEN 0 ELSE 
    ...
    "Modelica.Math.Vectors.interpolate({clutch3.mu_pos[1, 1]}, {clutch3.mu_pos[1, 2]}, clutch3.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,25), 1, 1), 
    RealTemporaryDense( &DYNX(DP_,26), 1, 1), DYNX(X_,7), 1).yi0_0_0member)
     ELSE IF DYNX(W_,66) THEN  -(PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch3.mu_pos[1, 1]}, {clutch3.mu_pos[1, 2]}, clutch3.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,25), 1, 1), 
    RealTemporaryDense( &DYNX(DP_,26), 1, 1), DYNX(X_,7), 1).yi0_0_0member)
     ELSE IF PRE(DYNX(W_,73), 5) == 1 THEN (PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch3.mu_pos[1, 1]}, {clutch3.mu_pos[1, 2]}, clutch3.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,25), 1, 1), 
    RealTemporaryDense( &DYNX(DP_,26), 1, 1), DYNX(X_,7), 1).yi0_0_0member)
     ELSE  -(PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch3.mu_pos[1, 1]}, {clutch3.mu_pos[1, 2]},  -clutch3.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,25), 1, 1), 
    RealTemporaryDense( &DYNX(DP_,26), 1, 1),  -DYNX(X_,7), 1).yi0_0_0member));
  PopAllMarks();
  DYNX(DYNhelp,17) = IF DYNX(W_,41) THEN 0.0 ELSE IF DYNX(W_,37) THEN 0 ELSE 
    ...
    "Modelica.Math.Vectors.interpolate({clutch2.mu_pos[1, 1]}, {clutch2.mu_pos[1, 2]}, clutch2.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,18), 1, 1), 
    RealTemporaryDense( &DYNX(DP_,19), 1, 1), DYNX(X_,5), 1).yi0_0_0member)
     ELSE IF DYNX(W_,40) THEN  -(PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch2.mu_pos[1, 1]}, {clutch2.mu_pos[1, 2]}, clutch2.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,18), 1, 1), 
    RealTemporaryDense( &DYNX(DP_,19), 1, 1), DYNX(X_,5), 1).yi0_0_0member)
     ELSE IF PRE(DYNX(W_,47), 3) == 1 THEN (PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch2.mu_pos[1, 1]}, {clutch2.mu_pos[1, 2]}, clutch2.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,18), 1, 1), 
    RealTemporaryDense( &DYNX(DP_,19), 1, 1), DYNX(X_,5), 1).yi0_0_0member)
     ELSE  -(PushModelContext(1,"Modelica.Math.Vectors.interpolate({clutch2.mu_pos[1, 1]}, {clutch2.mu_pos[1, 2]},  -clutch2.w_rel, 1)")
    Modelica_Math_Vectors_interpolate(RealTemporaryDense( &DYNX(DP_,18), 1, 1), 
    RealTemporaryDense( &DYNX(DP_,19), 1, 1),  -DYNX(X_,5), 1).yi0_0_0member));
  PopAllMarks();
  ...
  UpdateVariableNamed(DYNX(W_,10),"clutch1.startForward", PRE(DYNX(W_,18), 1)
     == 0 AND Greater(DYNX(W_,9),"clutch1.sa", IF PRE(DYNX(W_,10), 6) THEN 
    RealBmin(DYNX(W_,7), DYNX(W_,6)) ELSE DYNX(W_,7),"(if pre(clutch1.startForward) then min(clutch1.tau0_max, clutch1.tau0) else clutch1.tau0_max)",
     3) OR PRE(DYNX(W_,18), 1) == -1 AND Greater(DYNX(X_,3),"clutch1.w_rel", 
    DYNX(DP_,9),"clutch1.w_small", 4) OR initial() AND Greater(DYNX(X_,3),
    "clutch1.w_rel", 0,"0", 5));
  UpdateVariableNamed(DYNX(W_,11),"clutch1.startBackward", PRE(DYNX(W_,18), 1)
     == 0 AND Less(DYNX(W_,9),"clutch1.sa", IF PRE(DYNX(W_,11), 7) THEN RealBmax
    ( -DYNX(W_,7),  -DYNX(W_,6)) ELSE  -DYNX(W_,7),"(if pre(clutch1.startBackward) then max( -clutch1.tau0_max,  -clutch1.tau0) else  -clutch1.tau0_max)",
     6) OR PRE(DYNX(W_,18), 1) == 1 AND Less(DYNX(X_,3),"clutch1.w_rel",  -
    DYNX(DP_,9)," -clutch1.w_small", 7) OR initial() AND Less(DYNX(X_,3),
    "clutch1.w_rel", 0,"0", 8));
  ...
  UpdateVariableNamed(DYNX(W_,39),"clutch2.startForward", PRE(DYNX(W_,47), 3)
     == 0 AND Greater(DYNX(W_,38),"clutch2.sa", IF PRE(DYNX(W_,39), 8) THEN 
    RealBmin(DYNX(W_,36), DYNX(W_,35)) ELSE DYNX(W_,36),"(if pre(clutch2.startForward) then min(clutch2.tau0_max, clutch2.tau0) else clutch2.tau0_max)",
     9) OR PRE(DYNX(W_,47), 3) == -1 AND Greater(DYNX(X_,5),"clutch2.w_rel", 
    DYNX(DP_,23),"clutch2.w_small", 10) OR initial() AND Greater(DYNX(X_,5),
    "clutch2.w_rel", 0,"0", 11));
  UpdateVariableNamed(DYNX(W_,40),"clutch2.startBackward", PRE(DYNX(W_,47), 3)
     == 0 AND Less(DYNX(W_,38),"clutch2.sa", IF PRE(DYNX(W_,40), 9) THEN 
    RealBmax( -DYNX(W_,36),  -DYNX(W_,35)) ELSE  -DYNX(W_,36),"(if pre(clutch2.startBackward) then max( -clutch2.tau0_max,  -clutch2.tau0) else  -clutch2.tau0_max)",
     12) OR PRE(DYNX(W_,47), 3) == 1 AND Less(DYNX(X_,5),"clutch2.w_rel",  -
    DYNX(DP_,23)," -clutch2.w_small", 13) OR initial() AND Less(DYNX(X_,5),
    "clutch2.w_rel", 0,"0", 14));
  ...
  UpdateVariableNamed(DYNX(W_,65),"clutch3.startForward", PRE(DYNX(W_,73), 5)
     == 0 AND Greater(DYNX(W_,64),"clutch3.sa", IF PRE(DYNX(W_,65), 10) THEN 
    RealBmin(DYNX(W_,62), DYNX(W_,61)) ELSE DYNX(W_,62),"(if pre(clutch3.startForward) then min(clutch3.tau0_max, clutch3.tau0) else clutch3.tau0_max)",
     15) OR PRE(DYNX(W_,73), 5) == -1 AND Greater(DYNX(X_,7),"clutch3.w_rel", 
    DYNX(DP_,30),"clutch3.w_small", 16) OR initial() AND Greater(DYNX(X_,7),
    "clutch3.w_rel", 0,"0", 17));
  UpdateVariableNamed(DYNX(W_,66),"clutch3.startBackward", PRE(DYNX(W_,73), 5)
     == 0 AND Less(DYNX(W_,64),"clutch3.sa", IF PRE(DYNX(W_,66), 11) THEN 
    RealBmax( -DYNX(W_,62),  -DYNX(W_,61)) ELSE  -DYNX(W_,62),"(if pre(clutch3.startBackward) then max( -clutch3.tau0_max,  -clutch3.tau0) else  -clutch3.tau0_max)",
     18) OR PRE(DYNX(W_,73), 5) == 1 AND Less(DYNX(X_,7),"clutch3.w_rel",  -
    DYNX(DP_,30)," -clutch3.w_small", 19) OR initial() AND Less(DYNX(X_,7),
    "clutch3.w_rel", 0,"0", 20));
  UpdateVariableNamed(DYNX(W_,67),"clutch3.locked",  NOT DYNX(W_,63) AND  NOT (
    ...
    DYNX(W_,66)));
  MixedModeInit(18, DYNX(DYNhelp,87))
  ThetaMixedCross(0,3)
  ThetaMixedCross(1,4)
  ThetaMixedCross(2,5)
  ThetaMixedCross(3,6)
...
DYNX(W_,47) = IF DYNX(W_,37) THEN 2 ELSE IF (PRE(DYNX(W_,47), 3) == 1 OR PRE(
  ...
  "0", 11) THEN 1 ELSE IF (PRE(DYNX(W_,47), 3) == -1 OR PRE(DYNX(W_,47), 3) == 2
   OR DYNX(W_,40)) AND Less(DYNX(X_,5),"clutch2.w_rel", 0,"0", 14) THEN -1 ELSE 0;
DYNX(W_,18) = IF DYNX(W_,8) THEN 2 ELSE IF (PRE(DYNX(W_,18), 1) == 1 OR PRE(
  ...
  "0", 5) THEN 1 ELSE IF (PRE(DYNX(W_,18), 1) == -1 OR PRE(DYNX(W_,18), 1) == 2
   OR DYNX(W_,11)) AND Less(DYNX(X_,3),"clutch1.w_rel", 0,"0", 8) THEN -1 ELSE 0;
DYNX(W_,73) = IF DYNX(W_,63) THEN 2 ELSE IF (PRE(DYNX(W_,73), 5) == 1 OR PRE(
  ...
  "0", 17) THEN 1 ELSE IF (PRE(DYNX(W_,73), 5) == -1 OR PRE(DYNX(W_,73), 5) == 2
   OR DYNX(W_,66)) AND Less(DYNX(X_,7),"clutch3.w_rel", 0,"0", 20) THEN -1 ELSE 0;
...
0,560)
DeclareParameter("sin1.f", "Frequency of sine wave [Hz]", 11, 5, 0.0,0.0,0.0,0,560)
...
"J1.flange_a.tau", 1, 5, 0, 0)
DeclareParameter("sin1.offset", "Offset of output signal y [N.m]", 13, 0, \
0.0,0.0,0.0,0,560)
...
0,560)
DeclareVariable("sin2.f", "Frequency of sine wave [Hz]", 1, 0.0,0.0,0.0,0,513)
DeclareParameter("sin2.phase", "Phase of sine wave [rad|deg]", 33, \
1.570796326794897, 0.0,0.0,0.0,0,560)
DeclareAlias2("sin2.y", "Connector of Real output signal [1]", "clutch1.f_normalized", 1,\
 5, 25, 0)
DeclareParameter("sin2.offset", "Offset of output signal y [1]", 34, 0, 0.0,0.0,\
0.0,0,560)

...
/* DSblock model generated by Dymola from Modelica model BouncingBall
 Dymola Version 2021x (64-bit), 2020-10-09 translated this at Wed Jun  9 11:22:39 2021
...
#define NHash1_ -1050149359
#define NHash2_ -31574912
#define NHash3_ 0
#define NI_    0
#define NRelF_ 1
#define NRel_  2
...
0.0,0,2692)
DeclareParameter("test.k", "Constant output value", 10, 1.5, 0.0,0.0,0.0,0,560)
DeclareAlias2("test.y", "Connector of Real output signal", "test.k", 1, 7, 10, 0)
DeclareVariable("my_time", "[s]", 0.0, 0.0,0.0,0.0,0,512)
EndNonAlias(0)

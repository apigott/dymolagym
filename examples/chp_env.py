...
class JModelicaMECartPoleEnv(CartPoleEnv, FMI2MEEnv):
    ...
    def __init__(self,
                 m_flow_nominal,
                 switchThermalElectricalFollowing,
                 tEngIni,
                 waitTime,
                 time_step,
                 positive_reward,
                 ...
                 force,
                 log_level,
                 path="../../Buildings_Fluid_CHPs_Validation_ElectricalFollowing.fmu"):
        ...
        config = {
            'model_input_names': ['eleFol.TWatOutSet', 'eleFol.theFol', 'eleFol.PEleDem', 'eleFol.avaSig'],
            'model_output_names': ['eleFol.mWatSet_flow', 'eleFol.PCon', 'eleFol.PEleNet', 'eleFol.mFue_flow', 'eleFol.QWat_flow'],
            'model_parameters': {'eleFol.m_flow_nominal':m_flow_nominal, 'eleFol.switchThermalElectricalFollowing':switchThermalElectricalFollowing,
            'TEngIni':tEngIni, 'waitTime':waitTime},
            'initial_state': (),
            'time_step': time_step,

...
class PendulumEnvSEM(DymolaBaseEnv):
    """
    ...
    def __init__(self, mo_name, libs, default_action, time_step, positive_reward,
        ...
        self.action_names = ['k']
        self.state_names = ['nonlinearPendulum.theta','nonlinearPendulum.omega','nonlinearPendulum.my_time']
        # self.model_initial_names = {'theta0':'theta','omega0':'omega'}
        config = {

package ModelicaGym
    model CartPole "Classic cart pole simulated with an inverted pendulum"
                ...
                parameter Modelica.Units.SI.Angle theta_0 = 85/180*pi;
                ...
                Modelica.Blocks.Interfaces.RealInput f
                    annotation (Placement(transformation(extent={{-168,24},{-128,
              64}})));
    ...
    equation
      ...
      Line(points={{-28,-61.6667},{-28,-60},{25,-60},{25,-48},{44,-48}},       color = {0, 0, 127}));
      connect(
          angle.angles[3], theta) annotation (
      Line(points={{-28,-31.6667},{-28,-32},{44,-32}},   color = {0, 0, 127}));
    connect(theta, theta) annotation (
      ...
      Line(points={{-86,-60.3333},{-104,-60.3333},{-104,-58},{-120,-58},{-120,64},
            {9,64},{9,52},{44,52}},                                                                              color = {0, 0, 127}));
      connect(
          velocity.v_rel[1], x_dot) annotation (
      Line(points={{-86,-30.3333},{-100,-30.3333},{-100,-34},{-114,-34},{-114,56},
            {-3,56},{-3,34},{44,34}},                                                                                        color = {0, 0, 127}));
      connect(

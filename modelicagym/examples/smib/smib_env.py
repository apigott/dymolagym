...
class SMIBEnv(DymolaBaseEnvSimModel):
    """
    ...
    def __init__(self, mo_name, libs, default_action, time_step, positive_reward,
                 negative_reward, log_level, method, state_names):
    ...
    def _reward_policy(self):
        reward = -1#*np.linalg.norm(100*np.subtract(self.state,np.ones(2)))
